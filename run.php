...
use Api\Amazon\Adapters\OutboundShipping;
use Data\Order;
use Data\Raw\Buyer;
...
$buyer->country_code = 'US';
$buyer->country_code3 = 'USA';
...
$order->data = [
    ...
    'tracking_number' => '',
    'shipping_address' => 'Maria Garlick
37 Baird Rd
Lock Haven
PA
17745 United States
...
',
    ...
    'discount_sum' => '0',
    'shipping_type_id' => '1',
    'shipping_name' => 'Economy Shipping from outside US',
    'shipping_price' => '0',
    'final_price' => '98',
    'status' => '6',
    'hide_received' => '1',
...
$amazonOrder = new OutboundShipping();

$amazonOrder->ship($order, $buyer);
